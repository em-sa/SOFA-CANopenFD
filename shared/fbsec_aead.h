 ...
 *              FBSEC_SOD_ABORT_UNSUPPORTED so future bit assignments do
 ...
 * downgrade attempt (flipping bit 7 / bit 6, repurposing the reserved
 * bits, or swapping the base id) fails AEAD verification. */
